    ...
    bootstrapPage(
        navbarPage(
            ...
            tabPanel(
              ...
              br(),
              p(style = "text-align: justify;",
                "This dashboard can be accessed ",
                tags$a(href = "https://thedatadiary.net/texas-covid-tracker",
                       "as an embed link on thedatadiary.net"),
                " or ",
                tags$a(href = "https://markjrieke.shinyapps.io/txcovid/?_ga=2.238709189.418771402.1616420103-1018523707.1614637151",
                       " at the native Shiny server site.")),
              h3("Contact"),
              hr(),
              p(style = "text-align: justify;",
